<div id="cart" class="btn-group btn-block">
  <button type="button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-inverse pull-right btn-lg dropdown-toggle">
    <i class="fa fa-shopping-cart pull-left"></i> <span id="cart-total" class="pull-right"><?php echo $text_items; ?></span>
